...
a list of [`ImageResult`](illustration.schema.html.md#illustration.schema.ImageResult) (the normalized,
...
[`RetrievalSource`](illustration.base.html.md#illustration.base.RetrievalSource) and
...
| [`persist_sequence`](#illustration.persist_sequence)(result, \*[, store, actor, ...])  | Persist a [`SequenceResult`](illustration.sequence.html.md#illustration.sequence.SequenceResult) as lacing annotations. |
...
Bases: [`IllustrationError`](illustration.errors.html.md#illustration.errors.IllustrationError), [`ImportError`](https://docs.python.org/3/builtins/exceptions.html#ImportError)
...
alias of [`Signature`](illustration.duplicates.html.md#illustration.duplicates.Signature)
...
Bases: [`IllustrationError`](illustration.errors.html.md#illustration.errors.IllustrationError)
...
#### *property* dropped *: [list](https://docs.python.org/3/builtins/stdtypes.html#list)[[PrefilterReport](illustration.inspection.html.md#illustration.inspection.PrefilterReport)]*
...
Bases: [`ProviderError`](illustration.errors.html.md#illustration.errors.ProviderError)
...
#### info *: [SourceInfo](illustration.base.html.md#illustration.base.SourceInfo)* *= SourceInfo(name='', description='', requires_key=False, homepage=None, default_cacheable=True, license_note='', rate_limit='', tags=())*
...
* **Return type:**
  [`RubricScore`](illustration.inspection.html.md#illustration.inspection.RubricScore)
...
Bases: [`IllustrationError`](illustration.errors.html.md#illustration.errors.IllustrationError), [`KeyError`](https://docs.python.org/3/builtins/exceptions.html#KeyError)
...
* **Parameters:**
  ...
  * **budget** ([`Budget`](illustration.curation.html.md#illustration.curation.Budget) | [`None`](https://docs.python.org/3/builtins/constants.html#None)) – Hard loop bounds (defaults to [`Budget`](#illustration.Budget)).
...
* **Return type:**
  [`CurationResult`](illustration.curation.html.md#illustration.curation.CurationResult)
* **Returns:**
...
* **Return type:**
  [`SequenceResult`](illustration.sequence.html.md#illustration.sequence.SequenceResult)
...
* **Return type:**
  [`Signature`](illustration.duplicates.html.md#illustration.duplicates.Signature)
...
* **Return type:**
  [`list`](https://docs.python.org/3/builtins/stdtypes.html#list)[[`DuplicateGroup`](illustration.duplicates.html.md#illustration.duplicates.DuplicateGroup)]
...
* **Return type:**
  [`InspectReport`](illustration.inspection.html.md#illustration.inspection.InspectReport)
...
* **Return type:**
  [`SiglipScorer`](illustration.reranking.html.md#illustration.reranking.SiglipScorer)
...
Persist a [`SequenceResult`](illustration.sequence.html.md#illustration.sequence.SequenceResult) as lacing annotations.
...
* **Return type:**
  [`PrefilterResult`](illustration.inspection.html.md#illustration.inspection.PrefilterResult)
...
* **Return type:**
  [`Grade`](illustration.curation.html.md#illustration.curation.Grade)
...
* **Return type:**
  [`SequenceSelection`](illustration.sequence.html.md#illustration.sequence.SequenceSelection)
