...
alias of `Callable`[[[`ImageResult`](illustration.schema.html.md#illustration.schema.ImageResult), `Callable[[], Any]`], [`CheckOutcome`](#illustration.inspection.CheckOutcome)]
