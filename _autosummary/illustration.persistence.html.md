...
illustration [`SequenceResult`](illustration.sequence.html.md#illustration.sequence.SequenceResult) onto lacing — it does
...
([`illustration.schema.RIGHTS_FIELDS`](illustration.schema.html.md#illustration.schema.RIGHTS_FIELDS)) — alongside the candidate’s identity,
under the same field names [`ImageResult`](illustration.schema.html.md#illustration.schema.ImageResult) uses. The
...
| [`persist_sequence`](#illustration.persistence.persist_sequence)(result, \*[, store, actor, ...])   | Persist a [`SequenceResult`](illustration.sequence.html.md#illustration.sequence.SequenceResult) as lacing annotations.   |
|------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|
