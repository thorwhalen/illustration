...
| [`IllustrationError`](#illustration.errors.IllustrationError)                                | Base class for every error raised by [`illustration`](illustration.md#module-illustration).   |
|---------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------|
...
Base class for every error raised by [`illustration`](illustration.md#module-illustration).
